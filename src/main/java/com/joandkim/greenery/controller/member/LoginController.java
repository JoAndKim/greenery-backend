...
public class LoginController {
    ...
    @PostMapping("/direct")
    public ResponseEntity<NewAccessMemberResponse> login(@RequestBody LoginMemberRequest member) {
        NewAccessMemberResponse newAccessMemberResponse = loginService.login(member);
